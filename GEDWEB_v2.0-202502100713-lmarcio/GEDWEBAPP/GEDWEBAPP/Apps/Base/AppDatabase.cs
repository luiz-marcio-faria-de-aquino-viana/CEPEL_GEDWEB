...
namespace GEDWEBAPP.Apps.Base
{
    ...
    //Public
        ...
        public UsuarioRecord findUsuarioByLogin(string login)
        {
            UsuarioRecord oResult = m_tblUsuario.selectByLogin(login);
            return oResult;
        }
        ...
        public int insertDocumento(
            ...
            int autorId)
        {
            int rscode = m_tblDocumento.insertDocumento(
                documentoNome,
        ...
        public int updateDocumento(
            ...
            string documentoData)
        {
            int rscode = m_tblDocumento.updateDocumento(
                documentoId,
                documentoNome,
                documentoNomeArquivo,
                documentoDescricao,
        ...
        //
        public DocumentoRevisaoRecord findDocumentoRevisaoByPk(int documentoRevisaoId)
        {
            DocumentoRevisaoRecord oResult = m_tblDocumentoRevisao.selectByPk(documentoRevisaoId);
            return oResult;
        }
        ...
        {
            int result = m_tblDocumentoRevisao.insertDocumentoRevisao(
                documentoId,
                numeroRevisao,
